...
import { drawReviews, getMovieId } from "./detail.js";

const topLoginA = document.querySelector('.top_login');
...
const signOut = (e) => {
    ...
    changeTopLoginStatus(MOVIE_ID);
    drawReviews(reviews, MOVIE_ID);
}

export const changeTopLoginStatus = () => {
    const isLogin = getLocalStorage('islogin');
    if(isLogin.isLogin){
